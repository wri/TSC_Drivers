...
# DATA
#
PROJECT_ROOT = 'projects/wri-datalab/TSC_DRIVERS/2018'
TSC_DRIVERS_ID = PROJECT_ROOT + '/lossyear_classification'
HANSEN_THRESHOLDED_LOSS_ID = 'projects/wri-datalab/umd/HANSEN_BINARY_LOSS_18'
...
def main():
    ...
    parser.add_argument('-g', '--geom_name', default=DEFAULT_GEOM_NAME,
